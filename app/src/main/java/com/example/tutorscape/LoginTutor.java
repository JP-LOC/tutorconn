...
import static com.example.tutorscape.LoginStudent.myPrefs;
...
public class LoginTutor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editor.putBoolean("isTutor", true);
        editor.apply();
    ...
    private void init(){
                ...
                if(!isEmpty(mEmail.getText().toString())
                    ...
                    FirebaseAuth.getInstance().signInWithEmailAndPassword(mEmail.getText().toString(),
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(LoginTutor.this, "Authentication Failed", Toast.LENGTH_SHORT).show();
                            hideDialog();
                        }
                    });
                }else{
                    Toast.makeText(LoginTutor.this, "You didn't fill in all the fields.", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        register.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LoginTutor.this, RegisterTutor.class);
    ...
    public boolean servicesOK(){
        ...
        int isAvailable = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(LoginTutor.this);
        ...
        if(isAvailable == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(LoginTutor.this, isAvailable, ERROR_DIALOG_REQUEST);
            dialog.show();
        }
        else{
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    ...
                    if(user.isEmailVerified()){
                        ...
                        Toast.makeText(LoginTutor.this, "Authenticated with: " + user.getEmail(), Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(LoginTutor.this, "Email is not Verified\nCheck your Inbox", Toast.LENGTH_SHORT).show();
